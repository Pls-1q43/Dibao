...
This directory contains public reference documentation for users, contributors,
and plugin developers. Local planning notes, release execution logs, machine
specific test notes, and generated validation evidence are kept outside Git in
`local-docs/`.
